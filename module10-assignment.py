...
# Your code here
avg_spent_by_loyalty = df_no_duplicates[
    df_no_duplicates['loyalty_status'] != "None"
].groupby('loyalty_status')['total_spent'].mean()
...
print("- Data Type Issues: Dates, currency symbols, numeric formatting")
...
print("- Phone Numbers: Formatted as XXX-XXX-XXXX")
